                    ...
                    <div class="card-form">
                        <form action="{{ (request()->is('dashboard/pegawai/edit*'))? route('pegawai.update', ['id' => $pegawai->id]) : route('pegawai.store') }}" method="POST" style="padding-top: 0px">
                            ...
                            <div class="input-more break">
                                ...
                                <input type="text" name="nama_pegawai" value="{{(request()->is('dashboard/pegawai/edit*'))? $pegawai->name:''}}">
                                <br>
                                <label>Nomor Telepon<span style="color:red">*</span></label> <br>
                                <input type="text" name="no_telp" value="{{(request()->is('dashboard/pegawai/edit*'))? $pegawai->telp:''}}">
                                <br>
                                <label>Alamat<span style="color:red">*</span></label> <br>
                                <input type="text" name="alamat" value="{{(request()->is('dashboard/pegawai/edit*'))? $pegawai->alamat:''}}">
                                <br>
                                ...
                                <input type="email" name="email" value="{{(request()->is('dashboard/pegawai/edit*'))? $pegawai->email:''}}">
                                <br>
                                <label>Password<span style="color:red">*</span></label> <br>
                                <input type="password" name="password">
                                <br>
                                <br>
                                <input type="submit" value="{{(request()->is('dashboard/pegawai/edit*'))? 'Update Data':'Input Data'}}">
                            </div>
                        </form>
                    </div>
                </div>
