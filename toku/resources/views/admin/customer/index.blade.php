                    ...
                    <div class="card-form">
                        <form action="{{ (request()->is('dashboard/customer/edit*'))? route('customer.update', ['id' => $customer->id]) : route('customer.store') }}" method="POST" style="padding-top: 0px">
                            ...
                            <div class="input-more break">
                                ...
                                <input type="text" name="nama_customer" value="{{(request()->is('dashboard/customer/edit*'))? $customer->name:''}}" required>
                                <br>
                                <label>Nomor Telepon<span style="color:red">*</span></label> <br>
                                <input type="text" name="no_telp" value="{{(request()->is('dashboard/customer/edit*'))? $customer->telp:''}}" required>
                                <br>
                                <label>Alamat<span style="color:red">*</span></label> <br>
                                <input type="text" name="alamat" value="{{(request()->is('dashboard/customer/edit*'))? $customer->alamat:''}}" required>
                                <br>
