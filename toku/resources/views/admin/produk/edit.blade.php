...
<div class="card">
    <h2 style="margin-left: 20px">Edit Produk</h2>
    <div class="card-form">
        <form action="{{ route('produk.update', ['id' => $product->id]) }}" method="POST" enctype="multipart/form-data" style="padding-top: 0px">
            @csrf
            @method('PATCH')
            <div style="
                display: flex;
            ...
            ">
                <div class="image-preview" style="padding:0px; flex: 5;border-radius:5px;">
                    <img id="output" src= "{{asset('storage/'. $product->gambar_produk)}}" width="auto" height="100%" style=" background-size:contain;"/>
                </div>
            ...
            <div class="input-more" style="flex:3;">
                ...
                <input type="text" name="nama_produk" value="{{$product->nama_product}}">
                <br>
